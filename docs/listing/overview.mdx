...
1. Dapp listing guidelines – Make sure your dapp complies with the
   ...
   submit a PR\*.
2. Asset listing guidelines – If your dapp has its own Celo ERC-20
   asset associated with it, check here the [requirements](asset-guidelines) for assets to be
   supported in Valora. To list an asset, please follow [these
   instructions](adding-new-assets) on our Github to submit a PR\*.
...
each submission and only approve projects that adhere to our security
and UX standards.
...
feel free to reach out to our team on the [#dapp-dev](https://discord.com/channels/886972503560433675/887422238071087154).
